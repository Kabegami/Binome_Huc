...
/* Il s agit d un algorithme glouton qui renvoit les coordonnees de la premiere case de la bordure de la couleur qui contient le plus de cases */ 
...
int agrandit_zsg(int **M, S_Zsg *zone, int cl, int k, int l)
{
  ...
  do{
    ...
    /* Si la case adjacente est de la meme couleur et n'appartient pas a la liste des cases de la zone, alors on l'empile, si elle est de couleur differente, on l'ajoute a la bordure */
...
int sequence_aleatoire_rapide(int **M, Grille *G, int aff)
{
  ...
  /* tant qu'il y a plus d'une couleur dans la grille */
  do{
