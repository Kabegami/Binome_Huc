...
/* Dans cette fonction, on possede deux listes : L contenant les cases composant la zone et pile qui possede les cases adjacentes aux cases entrees en zone et se termine quand le premier element de la pile est egal au premier element de L */
...
int sequence_aleatoire_imp(int **M, Grille *G, int dim, int aff){
  ...
  do{
    ...
    if(new_couleur != couleur){
      ...
      /* actualise le nombre de couleurs de la grille dans le tableau de couleurs */
